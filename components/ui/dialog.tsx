...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-gray-900/30 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className,
    )}
    {...props}
  />
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'relative flex justify-between items-center border-b-2 border-gray-100 p-4',
      className,
    )}
    {...props}
  >
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t-2 border-gray-100 p-3 pt-4',
      className,
    )}
    {...props}
  />
